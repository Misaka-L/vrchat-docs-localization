...
如果您想要为您的账号开启二步身份验证，您可以先[登录到您的 VRChat 账号](https://vrchat.com/home/login)，点击 “编辑个人资料 (Edit Profile)”，向下滚动到 “两步验证 (Two-Factor Authentication)”，然后按指示完成设置。
